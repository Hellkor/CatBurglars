...
int main()
{
	...
	std::cout << "Going to open movie file \"" << "\"" << std::endl;
	
	sfe::Movie movie;
	if (!movie.openFromFile("Resources/Videos/spacetestSMALL.wmv"))
	{	
		my_pause();
		//return 1;
	}
	...
	// Create window
	sf::RenderWindow window(sf::VideoMode(1024, 720), "sfeMovie Player",
